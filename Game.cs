...
namespace HelloWorld
{
    ...
    class Game
    {
        ...
        bool StartBattle(int roomNum, ref int turnCount)
        {
            ...
            while (player1._playerHealth > 0 && enemyHealth > 0)
            {
                ...
                if (input == '1')
                {
                    ...
                    Console.Clear();
                    Console.WriteLine("You dealt " + (player1._playerDamage - enemyDefense) + " damage.");
                    Console.Write("> ");
                    Console.ReadKey();
                    Console.Clear();
        ...
        {
            char input;
            GetInput(out input, "Long Sword", "Dagger", "Player one choose a weapon");
            if (input == '1')
            {
            ...
            Console.Clear();
            GetInput(out input, "Long Sword", "Dagger", "Player two choose a weapon");
            if (input == '1')
            {
